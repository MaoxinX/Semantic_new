...
function consent_3FBRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of consent_3FBComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Cat_practiceRegisRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Cat_practiceRegisComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Ins7RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Ins7Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Fix_testRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Fix_testComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Cat_testregisRoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Cat_testregisComponents)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Ins8RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Ins8Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
...
function Ins10RoutineBegin(snapshot) {
  return async function () {
    ...
    for (const thisComponent of Ins10Components)
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
    return Scheduler.Event.NEXT;
  }
